...
namespace sdlw
{
        ...
        void saveImage(const char* fileName){
            int width, height;
            SDL_GetWindowSize(SDLWin, &width, &height);

            Uint32 pixelFormat = SDL_GetWindowPixelFormat(SDLWin);
            ...
            if (SDL_RenderReadPixels(SDLRen, NULL, pixelFormat, surface->pixels, surface->pitch) != 0) {
            ...
            if (SDL_SaveBMP(surface, fileName) != 0) {
                ...
                std::cout << "Saved drawing to " << fileName << std::endl;
            }
